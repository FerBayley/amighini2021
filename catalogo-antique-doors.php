...
/*
Template Name: catalogo-antique-doors
*/
...
<section class="columnasCentradas">
<div class="container-fluid mt-5 mb-5">
  <div class="row">
    <div class="col-12 col-md-2 colGaleria align-items-center">
      <?php query_posts('category_name=catalogo-antique-doors-col1&showposts=1000'); ?>
       ...
       <?php if ( has_post_thumbnail() ) {
        ...
        <?php echo limite_extracto( get_the_excerpt(), '20' ); ?>
        </div>
    ...
    <?php query_posts('category_name=catalogo-antique-doors-col2&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-antique-doors-col3&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-antique-doors-col4&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-antique-doors-col5&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-antique-doors-col6&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
