        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-6 efetoImg">
                    <a href="<?php echo esc_url( home_url( '/catalogo-home-decor' ) ); ?>">
                        <?php query_posts('category_name=imagen-home-decor-1&showposts=5'); ?>
                ...
                <div class="col-12 col-md-6 efetoImg">
                    <a href="<?php echo esc_url( home_url( '/catalogo-home-decor' ) ); ?>">
                       <?php query_posts('category_name=imagen-home-decor-2&showposts=5'); ?>
                       <?php while (have_posts()) : the_post(); ?>
                       <?php if ( has_post_thumbnail() ) {
                         the_post_thumbnail();
                       } ?>
