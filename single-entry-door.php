...
/*
Template Name: single-entry-door
*/
...
<div class="container-fluid mt-5 mb-5">
  <div class="row">
    <div class="col-12 col-md-2 colGaleria">
      <?php query_posts('category_name=catalogo-singleentreydoor-col1&showposts=1000'); ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-singleentreydoor-col2&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-singleentreydoor-col3&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-singleentreydoor-col4&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-singleentreydoor-col5&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
    ...
    <div class="col-12 col-md-2 colGaleria">
    <?php query_posts('category_name=catalogo-singleentreydoor-col6&showposts=1000'); ?>
       <?php while (have_posts()) : the_post(); ?>
       <?php if ( has_post_thumbnail() ) {
          the_post_thumbnail();
        } ?>
